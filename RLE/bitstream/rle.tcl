...
proc create_root_design { parentCell } {
  ...
  # Create instance: RLE, and set properties
  set RLE [ create_bd_cell -type ip -vlnv xilinx.com:hls:decompress:1.0 RLE ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins RLE/s_axi_AXILiteS] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins RLE/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_50M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_processing_system7_0_50M_peripheral_aresetn [get_bd_pins RLE/ap_rst_n] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00100000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs RLE/s_axi_AXILiteS/Reg] SEG_decompress_0_Reg
...
preplace inst decompress_0 -pg 1 -lvl 3 -y 130 -defaultsOSRD
...
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 180 420 270 680
levelinfo -pg 1 0 210 550 830 990 -top 0 -bot 370
",
}
