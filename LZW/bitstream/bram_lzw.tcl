...
proc create_root_design { parentCell } {
  ...
  # Create instance: bram_decompress_0, and set properties
  set bram_decompress_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:bram_decompress:1.0 bram_decompress_0 ]
...
CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY1 {.212} \
CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY2 {.085} \
CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY3 {.092} \
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins bram_decompress_0/s_axi_AXILiteS] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net bram_decompress_0_interrupt [get_bd_pins bram_decompress_0/interrupt] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins bram_decompress_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins bram_decompress_0/ap_rst_n] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00400000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs bram_decompress_0/s_axi_AXILiteS/Reg] SEG_bram_decompress_0_Reg
...
preplace inst bram_decompress_0 -pg 1 -lvl 3 -y 170 -defaultsOSRD -resize 282 128
...
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 190 430
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 2 440 20 NJ
preplace netloc bram_decompress_0_interrupt 1 0 4 10 0 NJ 0 NJ 0 1110
...
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 10 450 10 770
levelinfo -pg 1 -10 230 610 940 1130 -top -10 -bot 430
",
}
